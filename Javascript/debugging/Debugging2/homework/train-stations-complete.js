...
//console.log(distanceInMeters([52.3791283, 4.8980833], [52.0894444, 5.1077981]) + distanceInMeters([52.0894444, 5.1077981], [51.984034, 5.8983483]));
...
function routeLengthInKilometers(route) {
  if (route.length < 2) {
    ...
    for (let index = 0; index < route.length - 1; index++) {
      ...
      let totalLength = distanceBetweenStationsInMeters(currentStation, nextStation);
